...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            'created_for', sa.UUID(), autoincrement=False, nullable=False
        ),
        sa.Column(
            'updated_for', sa.UUID(), autoincrement=False, nullable=False
        ),
        sa.Column(
            'created_at',
    ...
    op.create_table(
        ...
        sa.Column(
            'hub',
            postgresql.ENUM(
                'Areias', 'SJBarreiro', 'Piquete', 'Silveiras', name='hubs'
            ),
            autoincrement=False,
            nullable=False,
        ),
        ...
        sa.Column(
            'created_for', sa.UUID(), autoincrement=False, nullable=True
        ),
        sa.Column(
            'updated_for', sa.UUID(), autoincrement=False, nullable=True
        ),
        sa.Column(
            'created_at',
            postgresql.TIMESTAMP(),
    ...
    op.create_table(
        ...
        sa.Column(
            'is_invalid', sa.BOOLEAN(), autoincrement=False, nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['fk_band'],
            ['bands.id'],
            name='exame_fk_band_fkey',
            ondelete='CASCADE',
        ),
        sa.ForeignKeyConstraint(
            ['fk_user'],
            ['users.id'],
            name='exame_fk_user_fkey',
            ondelete='CASCADE',
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['band_id'],
            ['bands.id'],
            name='band_kick_band_id_fkey',
            ondelete='CASCADE',
        ),
        sa.ForeignKeyConstraint(
            ['kick_id'],
            ['kicks.id'],
            name='band_kick_kick_id_fkey',
            ondelete='CASCADE',
        ),
    ...
    op.create_table(
        ...
        sa.Column('band_id', sa.UUID(), autoincrement=False, nullable=False),
        sa.Column(
            'poomsae_id', sa.UUID(), autoincrement=False, nullable=False
        ),
        sa.ForeignKeyConstraint(
            ['band_id'],
            ['bands.id'],
            name='band_poomsae_band_id_fkey',
            ondelete='CASCADE',
        ),
        sa.ForeignKeyConstraint(
            ['poomsae_id'],
            ['poomsaes.id'],
            name='band_poomsae_poomsae_id_fkey',
            ondelete='CASCADE',
        ),
        sa.PrimaryKeyConstraint(
            'band_id', 'poomsae_id', name='band_poomsae_pkey'
        ),
    )
    op.create_table(
        'band_kibondonjak',
        sa.Column('band_id', sa.UUID(), autoincrement=False, nullable=False),
        sa.Column(
            'kibondonjak_id', sa.UUID(), autoincrement=False, nullable=False
        ),
        sa.ForeignKeyConstraint(
            ['band_id'],
            ['bands.id'],
            name='band_kibondonjak_band_id_fkey',
            ondelete='CASCADE',
        ),
        sa.ForeignKeyConstraint(
            ['kibondonjak_id'],
            ['kibon_donjaks.id'],
            name='band_kibondonjak_kibondonjak_id_fkey',
            ondelete='CASCADE',
        ),
        sa.PrimaryKeyConstraint(
            'band_id', 'kibondonjak_id', name='band_kibondonjak_pkey'
        ),
    )
